...
const banner2 = cfonts.render((`Canal: https://www.youtube.com/@whesleyfernando\nDesenvolvedor Oficial: @whesleyfernando.exe`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`SONY|YOSHINO`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
